...
- understand — цель понять, НЕ договариваться и НЕ наказывать:
  «Начните с того, что вы заметили» → «Скажите, что хотите сначала понять» → «Спросите версию ребёнка» → «Уточните, чего он боялся» → «Договоритесь о следующем маленьком шаге».
  Не начинай с правила, наказания или «как исправить оценку».
...
- agree — цель совместное правило:
  ...
  Есть и обязательное условие, и детали на обсуждение + пробный срок.

- boundary — граница уже ваша, не голосование:
  «Коротко скажите, о чём речь» → «Объясните границу и почему она вам нужна» → «Выслушайте реакцию» → «Предложите обсудить только детали» → «Скажите, что будет при нарушении».
  Не пиши «давайте вместе решим, нужна ли граница».
...
- support — сначала контакт:
  «Начните с того, что вы заметили» → «Предложите рассказать в своём темпе» → «Выслушайте без советов» → «Спросите, какая помощь нужна» → при необходимости «Договоритесь о небольшом шаге».
  Советы — только если ребёнок просит.

- trust — восстановление доверия:
  «Начните с факта без ярлыков» → «Спросите, как это было для ребёнка» → «Уточните, что стояло за обманом» → «Расскажите, как это повлияло на доверие» → «Вместе найдите, как исправить» → «Договоритесь, как говорить правду в следующий раз».
...
- steps[].action — 1–2 бережных предложения в том же тоне.`;
