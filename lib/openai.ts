...
Важно про заголовки шагов (steps[].title) и тон сопровождения:
- Это подсказка родителю перед разговором, а не сценарий для специалиста.
- Пиши steps[].title мягким повелительным наклонением: «Начните…», «Спросите…», «Выслушайте…», «Предложите…», «Договоритесь…», «Объясните…».
- Не используй инфинитивы («Выбрать момент», «Назвать факт», «Обсудить варианты», «Зафиксировать договорённость») — они звучат методично и обезличенно.
- Избегай сухих и канцелярских формулировок: «Назовите факт», «Обозначьте правило», «Объясните важность режима», «Добейтесь договорённости».
- title и phrase должны совпадать по смыслу: не «перепрыгивай» через начало фразы.
- Если фраза начинается с наблюдения или чувства («Я заметил…», «Мне неприятно…», «Я вижу…»), title тоже про это — например «Начните с того, что вы заметили».
- steps[].action — одно-два бережных предложения в том же тоне (как совет человеку, а не инструкция методиста).
- Хорошие примеры title: «Начните с того, что вы заметили», «Спросите, почему он не ложится спать», «Вместе найдите подходящий вариант», «Договоритесь о правиле и попробуйте его соблюдать».
- Плохие примеры: «Выяснить, как ребёнок оценивает ситуацию», «Описать проблему без обвинения», «Обозначить обязательную границу», «Зафиксировать следующий шаг».`;
...
В steps[].title используй мягкое повелительное («Начните…», «Спросите…», «Договоритесь…»), без инфинитивов, и совпадай по смыслу с phrase.`;
}
